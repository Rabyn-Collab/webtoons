...
import 'package:webtoons/ui/pages/anime_viewer.dart';
import 'package:webtoons/ui/pages/detail.dart';
import 'package:webtoons/ui/pages/discover.dart';
import 'package:webtoons/ui/pages/manga_reader.dart';
    ...
    switch (settings.name) {
      case '/':
        return MaterialPageRoute(
            builder: (_) => const NavBar(title: 'webtoons'));
